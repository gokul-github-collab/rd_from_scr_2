...
const PsoUpdateForm = () => {
    ...
    const [course, setCourse] = useState(pso? pso.course : '')
    ...
    const updatePso = (e) => {
        e.preventDefault()
        api.put(`/api/psos/${id}/`, {title, description, course}). 
        then((res) => {
    ...
    {isSuperUser ?  <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-indigo-600 sm:text-4xl">Update
         Program Specific Outcomes (PSO's)</h2>
