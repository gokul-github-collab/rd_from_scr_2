...
const PoUpdateForm = () => {
    ...
    const [course, setCourse] = useState(po? po.course : '')
    ...
    const updatePo = (e) => {
        e.preventDefault()
        api.put(`/api/pos/${id}/`, {title, description, course}). 
        then((res) => {
            console.log(`${res.status}`)
            toast("Program Outcome updated successfully");
  ...
  return (
    ...
    {isSuperUser ?  <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-indigo-600 sm:text-4xl">Update
         Program Outcomes (PO's)</h2>
